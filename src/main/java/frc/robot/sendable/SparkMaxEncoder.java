...
public class SparkMaxEncoder implements IEncoder, Sendable {
     ...
     */
    public void setPositionConversionFactor(final double scaleFactor) {
     ...
     * @param scaleFactor The scaleFactor to set.
     */
    public void setVelocityConversionFactor(final double scaleFactor) {
    ...
    public void initSendable(final SendableBuilder builder) {
        ...
        builder.addDoubleProperty("Distance per Tick", this::getPositionConversionFactor, this::setPositionConversionFactor);
    }
}