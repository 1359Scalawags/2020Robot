...
public class OI {
    ...
    public OI() {
        ...
        intakeBallButton = new JoystickButton(assistController, Constants.DpadDOWN);
        intakeBallButton.whenPressed(new IntakeRollerSpin());
        //uptakeBallButton = new JoystickButton(assistController, Constants.DpadUP);  //TODO: ADD THIS IN
