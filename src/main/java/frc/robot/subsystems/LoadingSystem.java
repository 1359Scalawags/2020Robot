...
public class LoadingSystem extends SubsystemBase implements scheduler{
    ...
    */
    ...
    public LoadingSystem() {
        chamRotator = new CanMotor(Load.CANChamRotMotorID);
        ...
        ballLoaderInA = new Talon(Load.PWMLoadBallInMotorFrontID);
        ...
        ballLoaderUpB = new Talon(Load.PWMLoadBallUpMotorLeftID);
        ...
        ballLoaderCham = new Talon(Load.PWMLoadBallChamMotorID);
    ...
    */
    ...
    public void updateDash(boolean Override){    
        ...
        if(Override){
            ...
            ballLoaderInB.set(SmartDashboard.getNumber("Test", 0));
            double d = ballLoaderInB.get();
