...
public class BallSystem extends PIDSubsystem {
    ...
    */
    ...
    private SpeedControllerGroup ballShootMotors;
    private Talon ballLoaderA;
    private Talon ballLoaderB;
    private Talon ballLoaderC;
    private Talon ballLoaderD;
    private Talon ballLoaderE;
    ...
    public BallSystem() {
        ...
        ballLoaderA = new Talon(Constants.LoadBallMotorAID);
        addChild("BallLoaderA",ballLoaderA);
        ballLoaderA.setInverted(false);
        
        ballLoaderB = new Talon(Constants.LoadBallMotorBID);
        addChild("BallLoaderB",ballLoaderB);
        ballLoaderB.setInverted(false);

        ballLoaderC = new Talon(Constants.LoadBallMotorCID);
        addChild("BallLoaderC",ballLoaderC);
        ballLoaderC.setInverted(false);
        
        ballLoaderD = new Talon(Constants.LoadBallMotorDID);
        addChild("BallLoaderD",ballLoaderD);
        ballLoaderD.setInverted(false);

        ballLoaderE = new Talon(Constants.LoadBallMotorEID);
        addChild("BallLoaderE",ballLoaderE);
        ballLoaderE.setInverted(false);
    ...
    */
    ...
    public void setBallLoaderSpeed(double aMot, double bMot, double cMot, double dMot, double eMot) {
        ballLoaderA.set(aMot);
        ballLoaderB.set(bMot);
        ballLoaderC.set(cMot);
        ballLoaderD.set(dMot);
        ballLoaderE.set(eMot);
    }
