...
public class BallSystem extends PIDSubsystem {
    ...
    private CANSparkMax ballMotorA;
    private CANSparkMax ballMotorB;
    private CANSparkMax chamRotator;
    ...
    */
    ...
    public BallSystem() {
        ...
        chamRotator = new CANSparkMax(Constants.ChamRotMotorID);
        ballMotorA = new CANSparkMax(Constants.TopBallMotorID);
        ballMotorB = new CANSparkMax(Constants.BottomBallMotorID);
...
/*
        if(ballLoadInSpd <= 1, ballLoadUpSpd <= 1){
            set ballLoadInSpd = ballLoadUpSpd
            set ballLoadUpSpd = ballLoadUpSpd
        } else {
            set ballLoadInSpd = 0
            set ballLoadUpSpd = 0
        }
